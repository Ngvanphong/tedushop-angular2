...
export class SignalrService {
   ...
   private proxy: any;
   private proxyName: string = 'AnnoucementHub';
   ...
   constructor(private _authenService: AuthenService) {
     ...
     this.connection = $.hubConnection(SystemConstant.BASE_API);
     this.connection.qs = { "access_token": _authenService.getUserLogin().access_token };
